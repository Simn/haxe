...
(* OASIS_START *)
(* DO NOT EDIT (digest: c758e5406df8e79421eed998ef1555f7) *)
(*
...
let setup_t =
  {
     ...
     build = OCamlbuildPlugin.build ["-Xs"; "extra,lib,std,tests"];
     test = [];
     doc = [];
     ...
     package =
       {
          ...
          homepage = Some "http://haxe.org";
          bugreports = None;
          synopsis = "The Haxe compiler";
          description =
            Some [OASISText.Para "The Haxe cross-platform compiler"];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["ExtString"; "IO"; "MultiArray"];
                      lib_pack = false;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "libs/extc";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "extlib"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                      ...
                      bs_c_sources = ["extc_stubs.c"; "process_stubs.c"];
                      bs_data_files = [];
                      bs_findlib_extra_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["IlData"; "IlMeta"; "IlMetaDebug"];
                      lib_pack = false;
                      lib_internal_modules =
                        [
                           "Dump";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["JData"; "JReader"; "JWriter"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["c_objsize.c"];
                      bs_data_files = [];
                      bs_findlib_extra_files = [];
                      bs_ccopt =
                        [(OASISExpr.EBool true, ["-I../libs/objsize"])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_findlib_extra_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lpcre"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Native;
                      bs_build_depends =
                        [InternalLibrary "extlib"; InternalLibrary "swflib"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "extc";
                           InternalLibrary "extlib";
                           InternalLibrary "swflib";
                           InternalLibrary "ttflib";
                           FindlibPackage ("camlp4", None);
                           FindlibPackage ("unix", None);
                           FindlibPackage ("str", None);
                           InternalLibrary "pcre";
                           InternalLibrary "objsize"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "libs/ziplib";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "extc"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("cp", ["_build/src/main.native"; "haxe"])))
                 ]
            };
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "@K81\rµ\t”&\014ôN*&ú—";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
