...
let key_eval_vm_Process = hash "eval.vm.Process"
...
let key_stdin = hash "stdin"
let key_stdout = hash "stdout"
let key_stderr = hash "stderr"
let key_pid = hash "pid"
let key_running = hash "running"