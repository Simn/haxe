...
iter(econtinue, fail);
iter(ebreak, fail);
iter(efield, seq.bind("EConst(CString(foo,false))"));
...
check(ewhile1, ["EConst(CInt(1))", "EConst(CString(foo,false))"]);
check(ewhile2, ["EConst(CInt(1))", "EConst(CString(foo,false))"]);
check(ebinop, ["EConst(CInt(1))", "EConst(CInt(1))"]);
check(efor, ["EConst(CInt(1))", "EConst(CString(foo,false))"]);
check(ein, ["EConst(CIdent(i))", "EConst(CInt(1))"]);
check(evars, ["EConst(CInt(1))", "EConst(CInt(2))"]);
check(etry, ["EConst(CInt(1))", "EConst(CString(foo,false))", "EConst(CString(bar,false))"]);
